    ...
    <div className="min-h-[100dvh] w-full bg-[#FAFAF9] font-sans text-[#2A1400] flex flex-col selection:bg-[#FF7701]/20">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 shrink-0">
            <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center overflow-hidden">
              <img src={SBOLogo} alt="BukSU SBO Logo" className="w-12 h-12 object-contain" />
            </div>
            <div className="leading-none">
              <div className="flex items-center gap-1">
                <span className="text-[17px] font-black tracking-tight text-[#073474]">BukSU SBO</span>
                <span className="text-[17px] font-black tracking-tight text-slate-900">Printing System</span>
              </div>
              <p className="text-[10px] font-semibold text-slate-500 tracking-wide mt-0.5">Bukidnon State University</p>
            </div>
          </Link>
        ...
        {activeTab === 'track' ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 lg:p-8 shadow-xs">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="min-w-0">
                  <h1 className="text-lg sm:text-xl font-black text-[#1A140B] leading-tight">Track Printing Request</h1>
                  <p className="text-xs text-slate-500 font-medium leading-relaxed">
                    Check the current status and pickup readiness of your document
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleTrackSubmit} className="mt-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 px-3.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#073474]/20 focus:border-[#073474] text-sm uppercase font-mono font-semibold"
                  />
                  <p className="text-[11px] text-slate-400 mt-1">Given to you upon request submission</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 px-3.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#073474]/20 focus:border-[#073474] text-sm"
                  />
                  <p className="text-[11px] text-slate-400 mt-1">Used for privacy verification</p>
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full h-11 bg-[#073474] hover:bg-[#052554] text-white font-bold rounded-xl text-sm shadow-sm flex items-center justify-center gap-2"
                >
            ...
            {trackResult && (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
                  <div className="min-w-0">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Request Code</span>
                    <h2 className="text-lg sm:text-xl font-mono font-black text-[#073474] break-all">{trackResult.requestCode}</h2>
                  </div>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider border ${
                        trackResult.status === 'READY_FOR_CLAIM'
                          ...
                          : trackResult.status === 'PRINTING' || trackResult.status === 'PROCESSING'
                ...
                {trackResult.status === 'READY_FOR_CLAIM' && (
                  <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl flex items-start gap-3 text-emerald-800">
                    ...
                    <div className="text-xs">
                      ...
                      <strong>{trackResult.requestCode}</strong>, and present your student ID.
                    </div>
                  </div>
                )}
                ...
                {trackResult.status === 'REJECTED' && (
                  <div className="p-4 bg-red-50 border border-red-200 rounded-xl flex items-start gap-3 text-red-800">
                    ...
                    <div className="text-xs">
                      ...
                      Reason: {trackResult.rejectionReason || 'Please contact SBO office for clarification.'}
                    </div>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs bg-slate-50 p-4 rounded-xl border border-slate-200">
                  <div>
                    ...
                    <p className="font-bold text-slate-800">{trackResult.student.fullName}</p>
                  </div>
                  <div>
                    <span className="text-slate-500 font-medium">Department:</span>
                    <p className="font-bold text-slate-800">
                      {trackResult.student.department || 'College of Technologies'}
                    </p>
                  </div>
                  <div>
                    <span className="text-slate-500 font-medium">Document:</span>
                    <p className="font-bold text-slate-800 truncate">{trackResult.document.name}</p>
                  </div>
                  <div>
                    <span className="text-slate-500 font-medium">Specifications:</span>
                    <p className="font-bold text-slate-800">
                      {trackResult.options.paperSize} •{' '}
                      {trackResult.options.colorMode === 'color' ? 'Colored' : 'Black & White'} •{' '}
                      {trackResult.options.printSides === 'double' ? 'Double-sided' : 'Single-sided'} •{' '}
                      {trackResult.options.copies} {trackResult.options.copies === 1 ? 'copy' : 'copies'}
                    </p>
                  </div>
                </div>
                ...
                {/* Visual Timeline */}
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 mb-3">Progress Timeline</h3>
                  <div className="space-y-3">
                    {trackResult.timeline.map((step: PrintingTimelineStep, idx: number) => (
                        ...
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 text-xs ${
                            step.completed
                              ...
                              : step.current
                              ? 'bg-[#073474] text-white ring-4 ring-blue-100'
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-3 sm:p-5 shadow-xs overflow-hidden">
                <div className="grid grid-cols-4 gap-1 sm:gap-2 text-center">
                  {[
                    ...
                    return (
                      <div key={s.step} className="flex flex-col items-center min-w-0">
                        <div
                          className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-[11px] sm:text-xs font-bold mb-1 sm:mb-1.5 transition-all shrink-0 ${
                            isPassed
                              ? 'bg-emerald-500 text-white'
                              : isCurrent
                              ? 'bg-[#073474] text-white ring-4 ring-[#073474]/15'
                              : 'bg-slate-100 text-slate-400'
                          }`}
                        >
                          {isPassed ? <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> : s.step}
                        </div>
                        <span
                          className={`text-[9px] sm:text-[11px] font-semibold truncate max-w-full px-1 leading-tight ${
                            isCurrent
                              ? 'text-[#073474] font-bold'
                              : isPassed
                              ? 'text-slate-700'
                              : 'text-slate-400'
                          }`}
            ...
            {currentStep === 1 && (
              ...
              >
                <div className="border-b border-slate-100 pb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-black text-[#1A140B]">Step 1: Student Information</h2>
                  <p className="text-xs text-slate-500 font-medium mt-0.5 leading-relaxed">
                    No login or account needed. Please provide your student details for pickup verification.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <input
                      ...
                      className={`w-full h-11 px-3.5 rounded-xl border text-sm focus:outline-none focus:ring-2 ${
                        errors.fullName
                          ...
                          : 'border-slate-300 focus:border-[#073474] focus:ring-[#073474]/15'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setStudentInfo({ ...studentInfo, yearLevel: e.target.value })}
                      className="w-full h-11 px-3 rounded-xl border border-slate-300 bg-white text-sm focus:outline-none focus:border-[#073474] focus:ring-2 focus:ring-[#073474]/15"
                    >
                      {YEAR_LEVELS.map((yr) => (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setStudentInfo({ ...studentInfo, confirmEmail: e.target.value })}
                      className={`w-full h-11 px-3.5 rounded-xl border text-sm focus:outline-none focus:ring-2 ${
                        errors.confirmEmail
                          ? 'border-red-400 bg-red-50/30 focus:ring-red-200'
                          : 'border-slate-300 focus:border-[#073474] focus:ring-[#073474]/15'
                    ...
                    />
                    {errors.confirmEmail && <p className="text-[11px] text-red-500 mt-1">{errors.confirmEmail}</p>}
                  </div>
                </div>
                ...
                <div className="p-3 bg-amber-50/70 border border-amber-200/80 rounded-xl flex items-start gap-2.5 text-amber-900 text-xs">
                  ...
                  <span>
                    Make sure your email address is correct because important request notifications (including your
                    pickup alert) will be sent there.
                  </span>
                </div>
                ...
                <div className="pt-2">
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input
                      ...
                      className="mt-0.5 h-4 w-4 rounded text-[#073474] border-slate-300 focus:ring-[#073474]"
                    />
                    <span className="text-xs font-medium text-slate-700">
                      I confirm that the information I provided is correct and matches my University Student ID.
                    </span>
                  </label>
                  {errors.infoConfirmed && (
                    <p className="text-[11px] text-red-500 mt-1 pl-7">{errors.infoConfirmed}</p>
                  )}
                </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-between items-stretch sm:items-center gap-3 pt-4 border-t border-slate-100">
                  <Link to="/" className="w-full sm:w-auto">
                    <Button variant="outline" className="w-full sm:w-auto h-11 px-5 rounded-xl text-xs font-bold text-slate-600">
                      Cancel
                    </Button>
                  </Link>
                  <Button
                    onClick={handleNextStep1}
                    className="w-full sm:w-auto h-11 px-5 sm:px-6 bg-[#073474] hover:bg-[#052554] text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 shadow-xs"
                  >
                    <span className="hidden sm:inline">Next: Document Upload</span>
            ...
            {currentStep === 2 && (
              ...
              >
                <div className="border-b border-slate-100 pb-4">
                  <h2 className="text-lg sm:text-xl font-black text-[#1A140B]">Step 2: Upload Document</h2>
                  <p className="text-xs text-slate-500 font-medium mt-0.5 leading-relaxed">
                    Upload the exact document you want printed. Maximum file size is 25 MB.
                  </p>
                </div>
                ...
                {!document ? (
                  <div
                    ...
                    className={`border-2 border-dashed rounded-2xl p-6 sm:p-8 lg:p-12 text-center cursor-pointer transition-all ${
                      isDragging
                        ? 'border-[#073474] bg-blue-50/50 scale-[0.99]'
                        : 'border-slate-300 hover:border-[#073474]/50 bg-slate-50/50 hover:bg-slate-50'
                    }`}
                  >
                    <input
                      type="file"
                    ...
                    <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-[#073474] shadow-xs mb-3 sm:mb-4">
                      <UploadCloud className="w-6 h-6 sm:w-7 sm:h-7 text-[#FF7701]" />
                    </div>

                    <h3 className="text-sm sm:text-base font-bold text-slate-800 px-2">Drag & Drop Your File Here</h3>
                    <p className="text-xs text-slate-500 mt-1 px-2">or click to browse from your device</p>

                    <div className="mt-6 inline-block bg-white px-4 py-2 rounded-xl border border-slate-200 text-xs font-bold text-[#073474] shadow-xs">
                      Choose File
                    </div>

                    <div className="mt-6 text-[11px] text-slate-400">
                      Supported formats: <strong>PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, JPG, PNG</strong> (Max 25 MB)
                    </div>
                  </div>
                ) : (
                  /* Active File Card */
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-4">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-center gap-3.5 min-w-0">
                        <div className="w-12 h-12 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-[#073474] shrink-0 shadow-xs">
                          <FileText className="w-6 h-6 text-[#FF7701]" />
                        </div>
                        <div className="min-w-0">
                          <h4 className="text-sm font-bold text-slate-800 truncate">{document.name}</h4>
                          <p className="text-xs text-slate-500 mt-0.5">
                            {formatFileSize(document.size)} • {document.type || 'Document'}
                          </p>
                        </div>
                      </div>
                ...
                <div className="p-3 bg-blue-50/70 border border-blue-200/80 rounded-xl text-xs text-blue-900 flex items-start gap-2.5">
                  <ShieldCheck className="w-4 h-4 text-[#073474] shrink-0 mt-0.5" />
                  <span>
                    Your uploaded file is transmitted securely and organized directly into the COT SBO student
                    printing queue. Only authorized staff members can view it for printing.
                  </span>
                </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-between gap-3 pt-4 border-t border-slate-100">
                  ...
                  <Button
                    ...
                    className="w-full sm:w-auto h-11 px-5 sm:px-6 bg-[#073474] hover:bg-[#052554] text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 shadow-xs"
                  >
                    <span className="hidden sm:inline">Next: Printing Options</span>
                    <span className="sm:hidden">Next</span>
                    <ArrowRight className="w-4 h-4 shrink-0" />
                  </Button>
                </div>
            ...
            {currentStep === 3 && (
              ...
              >
                <div className="border-b border-slate-100 pb-4">
                  <h2 className="text-lg sm:text-xl font-black text-[#1A140B]">Step 3: Printing Options</h2>
                  <p className="text-xs text-slate-500 font-medium mt-0.5 leading-relaxed">
                    Specify how you want your document printed by the COT SBO office.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {(['A4', 'Letter', 'Legal', 'Other'] as const).map((size) => (
                        <button
                          key={size}
                          type="button"
                          ...
                          className={`h-11 px-3 rounded-xl border text-xs font-bold transition-all text-center ${
                            options.paperSize === size
                              ? 'border-[#073474] bg-[#073474] text-white shadow-xs'
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        type="button"
                        onClick={() => setOptions({ ...options, printSides: 'single' })}
                        className={`h-11 px-3 rounded-xl border text-xs font-bold transition-all ${
                      ...
                      <button
                        type="button"
                        onClick={() => setOptions({ ...options, printSides: 'double' })}
                        className={`h-11 px-3 rounded-xl border text-xs font-bold transition-all ${
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        type="button"
                        onClick={() => setOptions({ ...options, copies: Math.min(50, options.copies + 1) })}
                        className="w-11 h-11 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 text-slate-800 font-bold text-lg flex items-center justify-center"
                      >
                        +
                      </button>
                  ...
                  <div className="sm:col-span-2 space-y-3">
                    ...
                    <div className="flex items-center gap-6">
                      <label className="flex items-center gap-2 cursor-pointer text-xs font-bold text-slate-700">
                        <input
                          ...
                          onChange={() => setOptions({ ...options, pageSelection: 'all' })}
                          className="h-4 w-4 text-[#073474]"
                        />
                        <span>All Pages</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer text-xs font-bold text-slate-700">
                        <input
                          ...
                          onChange={() => setOptions({ ...options, pageSelection: 'specific' })}
                          className="h-4 w-4 text-[#073474]"
                        />
                    ...
                    {options.pageSelection === 'specific' && (
                      <div>
                        ...
                        />
                        {errors.pageRange && <p className="text-[11px] text-red-500 mt-1">{errors.pageRange}</p>}
                        <p className="text-[11px] text-slate-400 mt-1">Specify comma-separated pages or page ranges.</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full p-3 rounded-xl border border-slate-300 text-sm focus:outline-none focus:border-[#073474] focus:ring-2 focus:ring-[#073474]/15"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-between gap-3 pt-4 border-t border-slate-100">
                  ...
                  <Button
                    ...
                    className="w-full sm:w-auto h-11 px-5 sm:px-6 bg-[#073474] hover:bg-[#052554] text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 shadow-xs"
                  >
                    <span className="hidden sm:inline">Next: Review Request</span>
                    <span className="sm:hidden">Next</span>
                    <ArrowRight className="w-4 h-4 shrink-0" />
                  </Button>
                </div>
            ...
            {currentStep === 4 && (
              ...
              >
                <div className="border-b border-slate-100 pb-4">
                  <h2 className="text-lg sm:text-xl font-black text-[#1A140B]">Step 4: Review Your Request</h2>
                  <p className="text-xs text-slate-500 font-medium mt-0.5 leading-relaxed">
                    Please review all your information and printing instructions before final submission.
                  </p>
                </div>
                ...
                <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50/50">
                  <div className="flex items-center justify-between pb-3 border-b border-slate-200/80 mb-3">
                    <h3 className="text-xs font-black uppercase tracking-wider text-[#073474]">Student Information</h3>
                    <button
                      type="button"
                      onClick={() => setCurrentStep(1)}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <div>
                      ...
                      <strong className="text-slate-900">{studentInfo.fullName}</strong>
                    </div>
                    <div>
                      <span className="text-slate-500">Student ID:</span>{' '}
                      <strong className="text-slate-900 font-mono">{studentInfo.studentId}</strong>
                    </div>
                    <div>
                      <span className="text-slate-500">Department:</span>{' '}
                      <strong className="text-slate-900">{studentInfo.department}</strong>
                    </div>
                    <div>
                      <span className="text-slate-500">Year Level:</span>{' '}
                      <strong className="text-slate-900">{studentInfo.yearLevel}</strong>
                    </div>
                    <div className="sm:col-span-2">
                      <span className="text-slate-500">Email Address:</span>{' '}
                      <strong className="text-slate-900">{studentInfo.email}</strong>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50/50">
                  <div className="flex items-center justify-between pb-3 border-b border-slate-200/80 mb-3">
                    <h3 className="text-xs font-black uppercase tracking-wider text-[#073474]">Document</h3>
                    <button
                      type="button"
                      onClick={() => setCurrentStep(2)}
                      className="text-xs font-bold text-[#FF7701] hover:underline"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div>
                      ...
                      <p className="font-bold text-slate-900 truncate mt-0.5">{document?.name}</p>
                    </div>
                    <div>
                      <span className="text-slate-500">File Type:</span>
                      <p className="font-bold text-slate-900 mt-0.5">{document?.type || 'Document'}</p>
                    </div>
                    <div>
                ...
                <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50/50">
                  <div className="flex items-center justify-between pb-3 border-b border-slate-200/80 mb-3">
                    <h3 className="text-xs font-black uppercase tracking-wider text-[#073474]">Printing Specifications</h3>
                    <button
                      type="button"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                    <div>
                      ...
                      <p className="font-bold text-slate-900">{options.paperSize}</p>
                    </div>
                    <div>
                      <span className="text-slate-500">Color:</span>
                      <p className="font-bold text-slate-900">
                        {options.colorMode === 'color' ? 'Colored' : 'Black & White'}
                      </p>
                    </div>
                    <div>
                      <span className="text-slate-500">Sides:</span>
                      <p className="font-bold text-slate-900">
                        {options.printSides === 'single' ? 'Single-sided' : 'Double-sided'}
                      </p>
                    </div>
                    <div>
                      <span className="text-slate-500">Copies:</span>
                      <p className="font-bold text-slate-900 font-mono">{options.copies}</p>
                    </div>
                    <div className="col-span-1 sm:col-span-2 lg:col-span-4">
                      <span className="text-slate-500">Pages:</span>
                      <p className="font-bold text-slate-900 break-words">
                        {options.pageSelection === 'all' ? 'All Pages' : `Specific Pages: ${options.pageRange}`}
                      </p>
                    </div>
                    {options.additionalInstructions && (
                      <div className="col-span-1 sm:col-span-2 lg:col-span-4 pt-1">
                        <span className="text-slate-500">Instructions:</span>
                        <p className="font-medium text-slate-800 italic">"{options.additionalInstructions}"</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    />
                    <span className="text-xs font-medium text-slate-700">
                      I have reviewed my request and confirm that all information and printing instructions are correct.
                    </span>
                  </label>
                </div>
            ...
            {currentStep === 5 && submittedRecord && (
              ...
              >
                ...
                <div className="px-2">
                  ...
                  <h2 className="text-xl sm:text-2xl font-black text-[#1A140B] leading-tight">REQUEST SUBMITTED SUCCESSFULLY</h2>
                  <p className="text-xs text-slate-500 mt-1 max-w-[42ch] mx-auto leading-relaxed">
                    Your printing request has been received by the COT SBO office and placed in the processing queue.
                  </p>
                </div>

                {/* Prominent Request Code Box - responsive, prevents overflow */}
                <div className="bg-[#073474] text-white rounded-2xl p-4 sm:p-6 shadow-sm overflow-hidden">
                  ...
                  <p className="text-xs text-blue-100 max-w-[40ch] mx-auto">
                    Present this code at the COT SBO Office counter when claiming your printed documents.
                  </p>

                  <div className="mt-4 flex justify-center">
                    <button
                      type="button"
                      onClick={() => handleCopyCode(submittedRecord.requestCode)}
                    ...
                    >
                      ...
                      <span>{copiedCode ? 'Copied to Clipboard!' : 'Copy Request Code'}</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-left text-xs space-y-2">
                  <div className="flex justify-between">
                    <span className="text-slate-500">Department:</span>
                    <strong className="text-slate-900">{submittedRecord.student.department}</strong>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Document:</span>
                    <strong className="text-slate-900 truncate max-w-[200px]">{submittedRecord.document.name}</strong>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Copies:</span>
                    <strong className="text-slate-900 font-mono">{submittedRecord.options.copies}</strong>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Confirmation Sent To:</span>
                    <strong className="text-slate-900">{submittedRecord.student.email}</strong>
                  </div>
                </div>

                {/* Important Next Steps */}
                <div className="p-4 bg-amber-50/70 border border-amber-200/80 rounded-xl text-left text-xs text-amber-950 space-y-1.5">
                  <strong className="block text-sm font-bold text-amber-900">📌 Important Claiming Instructions:</strong>
                  <p>1. Please check your email for the official submission confirmation.</p>
                  <p>2. Wait until you receive our <strong>"Ready for Claim"</strong> email before going to the COT SBO office.</p>
                  <p>3. Bring your <strong>Valid Student ID</strong> and mention code <strong>{submittedRecord.requestCode}</strong> at the counter.</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  <Link to="/" className="flex-1">
                    <Button className="w-full h-11 bg-[#073474] hover:bg-[#052554] text-white rounded-xl text-xs font-bold">
                      Back to Home
                    </Button>
                  </Link>
                </div>
      ...
      <footer className="w-full bg-white border-t border-slate-200 py-6 text-center text-xs text-slate-400 mt-auto">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p>© {new Date().getFullYear()} Bukidnon State University • College of Technologies SBO. All rights reserved.</p>
          <div className="flex items-center gap-4 text-[11px] font-semibold text-slate-500">
            <Link to="/" className="hover:text-[#073474]">Home</Link>
            <button type="button" onClick={() => setActiveTab('track')} className="hover:text-[#073474]">
              Track Request
            </button>
            <Link to="/login" className="hover:text-[#073474]">Staff Portal</Link>
          </div>
        </div>
      </footer>
    </div>
